...
import { Category, getCategoriesByUser, getTodosByUser } from "../utils/db.ts";
    ...
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-200 animate-fade-in-up">
      <main class="max-w-4xl mx-auto px-4 py-12">
        <div class="mb-12">
          <a
            href="/"
            class="text-sm font-bold text-brand-600 hover:text-brand-700 mb-4 inline-flex items-center gap-2 group transition-all"
          >
            <svg
